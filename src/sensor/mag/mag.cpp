...
void Magnetmeter::initialize() {
    ...
    offset_ = {159.73, -694.93, 38.63};  // bibox

    // scaling_matrix_ = {0.01003836, -0.00011478, 0.00073942, 0.0, 0.00943432, -0.00023855, 0.0, 0.0, 0.01126153}; //
    // lab
    // scaling_matrix_ = {0.0132270994, 0.0000968772223, -0.000525366524, 0.0, 0.0127846141, 0.0000175841433, 0.0,
    //                    0.0,          0.0151829581};  //  home

    scaling_matrix_ = {0.818, -0.160, -0.128, 
                        -0.160, 1.287, 0.043, 
                        -0.128, -0.043, 0.997};  //  bibox
...
void Magnetmeter::update() {
    if (micros() - last_update_time_ < SENSOR::MAG_UPDATE_DU * 1000 * 1000) return;
